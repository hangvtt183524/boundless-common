  ...
  methods: {
    getNodeById (nodeId, productUserObject = null) {
      ...
      if (productUserObject === null) {
        ...
        return productUserObject.userOrganizationNodes.find(node => node.id === nodeId) ||
          productUserObject.userWorkspaces.find(node => node.id === nodeId) ||
          productUserObject.userWorkspaceOrganizations.find(node => node.id === nodeId)
      }
    },
