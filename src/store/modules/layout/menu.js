export default [
    ...
    },
    {
        ...
        'class': 'deployment',
        'prefix': 'deployment_',
        'description': 'Automate your network deployment, configuration, and device setup',
        'image': 'menu-captive-portal.png',
        'default_page': 'NetworkCreationFlowList',
        'product_permission_sets': [
            ['network_deployment__deploy']
        ],
        'subgroups': [
            {
                'name': 'batch creation',
        ...
        'submenu': [
            {
                'translation': 'network_creation_flow',
                'subgroup': 'batch creation',
                'route': 'NetworkCreationFlowList',
                'permission_sets': [
                    ['network_deployment__deploy']
                ]
            },
    ...
    },
    {
        ...
        'class': 'logs',
        'prefix': 'logs_',
        'description': 'Launch dedicated servers to collect and monitor Syslog data.',
        'translation': 'logs',
        'default_page': 'SyslogServerList',
        'product_permission_sets': [
            ['syslog__view_servers']
        ],
        'subgroups': [
            {
                'name': 'servers',
