<template>
  <div class="tags-input" :class="{ 'focused' : focused }">
    <div class="input-wrap" v-if="!disabled">
      <v-text-field
          class="tag-field no-border"
          v-model="newTag"
      ...
      <v-btn round large outline color="success" @click="addTag" :disabled="!newTag">
        Add
