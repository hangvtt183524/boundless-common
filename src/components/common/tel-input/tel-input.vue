<template>
  <div class="tel-input" :class="{'tel-input--readonly': readonly}">
    ...
    <div class="error-messages" data-test="phone-error-messages">
      <div class="error-item"
           v-if="error || errorMessages[0]" data-test="phone-error"
      >
