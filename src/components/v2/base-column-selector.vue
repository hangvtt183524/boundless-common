<template>
  <div class="base-column-selector" v-click-outside='onClickOutside'>
    <div class="base-column-selector__activator"
         @click="onOpenDialog"
    >
      Select columns
    </div>
    ...
    <transition name='slide'>
      <div class="base-column-selector__dialog" v-show="dialogExpanded">
        <div class="base-column-selector__dialog__header">
          Select columns
        </div>

        <div class="base-column-selector__dialog__body" v-if="!isTree">
          <div class="base-column-selector__dialog__body__item"
        ...
        <div class="base-column-selector__dialog__body" v-else>
          <v-treeview
              :items="treeData"
              multiple-active
              selectable
